...
if (isset($_POST['submit'])) {
    ...
    $hashed_pass = password_hash(password: $password, algo: PASSWORD_DEFAULT);

    $insert_user = mysqli_query($conn, "INSERT INTO tbl_users (firstname, middlename, lastname, username, password, email) VALUES ('$firstname', '$middlename', '$lastname', '$username', '$password', '$email')" );
